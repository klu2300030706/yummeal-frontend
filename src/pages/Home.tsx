...
import { ArrowRight, Search, Timer, Utensils, BarChart3 } from 'lucide-react';
...
const Home = () => {
  const { user, featuredRestaurants, popularItems } = useApp();
        ...
        <div className="yummeal-container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 justify-center">
              ...
              <Link to="/explore">
                <Button className="bg-yummeal-orange hover:bg-opacity-90 py-6 px-8">
                  Find Food
                </Button>
              </Link>
            </div>
